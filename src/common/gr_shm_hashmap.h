 ...
 *
 * IDENTIFICATION
 *    src/common/gr_shm_hashmap.h
 *
 * -------------------------------------------------------------------------
 */

#ifndef __GR_SHM_HASHMAP_H_
#define __GR_SHM_HASHMAP_H_
...
#define GR_MAX_SEGMENT_NUM (1024)
#define GR_MAX_BUCKET_NUM (2097152)
#ifdef ENABLE_GRTEST
#define GR_INIT_BUCKET_NUM (2048)
#else
#define GR_INIT_BUCKET_NUM (32768)
#endif

#define GR_BUCKETS_PER_SEGMENT (GR_MAX_BUCKET_NUM / GR_MAX_SEGMENT_NUM)
#define GR_BUCKETS_SIZE_PER_SEGMENT (GR_BUCKETS_PER_SEGMENT * sizeof(shm_hashmap_bucket_t))
#define GR_EXTEND_BATCH (128)
#define GR_HASH_FILL_FACTOR ((float)0.75)
