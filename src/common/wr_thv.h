...
typedef enum tag_wr_thv_run_ctx_item {
    WR_THV_RUN_CTX_ITEM_SESSION = 0,  // bind one session to cur thd
    WR_THV_RUN_CTX_ITEM_MAX,
...
typedef enum tag_thv_type {
    GLOBAL_THV_OBJ0 = 0,  // had been occupied by wr connection
    GLOBAL_THV_OBJ1 = 1,  // wr connection options
    GLOBAL_THV_OBJ2 = 2,
