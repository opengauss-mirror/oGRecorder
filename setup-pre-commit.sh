#!/usr/bin/env bash
# =============================================================================
# setup-pre-commit.sh -- install oGRecorder pre-commit checks in an isolated venv.
#
# Design:
...
git rev-parse --show-toplevel >/dev/null 2>&1 || die "run this script inside the oGRecorder git repository"
